  ...
  return (
    <header className="sticky top-0 py-3 -mx-6 md:p-3 flex items-start justify-around md:mx-auto z-50 xl:items-center backdrop-blur-sm bg-slate-800/30 ">
      ...
      >
        ...
        {/* Social icons */}
        <SocialIcon
          url="https://www.linkedin.com/in/alhamdou-jallow/"
          fgColor="#a9a9a9"
          bgColor="transparent"
          className="ml-3"
        />
        <SocialIcon
          url="https://www.twitter.com/scientist_jalz"
          fgColor="#a9a9a9"
          bgColor="transparent"
        />
        <SocialIcon
          url="https://github.com/Alhamdou"
          fgColor="#a9a9a9"
          bgColor="transparent"
        />
      </motion.div>
      ...
      >
        ...
        <p className="hidden md:inline-flex text-sm text-[#a9a9a9]">
          <a href="#contact">Get in touch  +2202424045</a>
